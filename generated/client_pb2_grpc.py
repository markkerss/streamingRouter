...
import generated.client_pb2 as client__pb2
...
class ClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReceiveResponse = channel.unary_unary(
                ...
                request_serializer=client__pb2.Response.SerializeToString,
...
def add_ClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ReceiveResponse': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=client__pb2.Response.FromString,
...
class Client(object):
    ...
    def ReceiveResponse(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/client.Client/ReceiveResponse',
            client__pb2.Response.SerializeToString,
